...
export default baitsData = {
  2585: {
    ...
    level: 1,
    acquisition: ["grd", "evr", "m&m", "jnk", "shi", "lim", "ver", "uld"],
    ...
    level: 5,
    acquisition: ["cul", "lim", "hyr", "grd", "uld", "m&m"],
    ...
    level: 25,
    acquisition: ["cul", "ect", "m&m", "arm", "a&m"],
    ...
    level: 30,
    acquisition: ["grd", "evr", "jnk", "m&m", "shi", "lim", "ver", "uld"],
    ...
    level: 35,
    acquisition: ["cul", "grd", "evr", "jnk", "m&m", "shi", "lim", "ver", "uld"],
    ...
    level: 32,
    acquisition: ["gsm", "grd", "evr", "jnk", "m&m", "shi", "lim", "ver", "uld"],
    ...
    level: 41,
    acquisition: ["gsm", "grd", "evr", "m&m", "jnk", "shi", "lim", "ver", "uld"],
    ...
    level: 120,
    acquisition: ["eop", "evr", "pow", "ren", "shi", "ver"],
    fishes: [4937, 5544]
  }, 12705: {
    ...
    level: 15,
    acquisition: ["hyr", "a&m", "jnk", "uld", "evr", "ect", "arm", "ind", "lim", "grd", "m&m"],
    ...
    level: 15,
    acquisition: ["grd", "arm", "a&m", "ect", "evr", "ind", "jnk", "m&m", "lim", "tsm", "uld"],
